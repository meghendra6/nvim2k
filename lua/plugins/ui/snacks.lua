...
Snacks.setup({
    ...
    picker = {
        ...
        sources = {
            ...
            diagnostics_buffer = { layout = files_layout() },
            files = {
                hidden = true,
                layout = files_layout(),
            },
            grep_buffers = { layout = files_layout() },
            icons = {
            ...
            git_log = { layout = files_layout() },
            git_log_file = { layout = files_layout() },
            git_status = { layout = files_layout() },
            help = { layout = { preset = 'ivy_split' } },
            jumps = { layout = files_layout() },
            lines = { layout = files_layout() },
            man = { layout = { preset = 'ivy_split' } },
            loclist = { layout = files_layout() },
            lsp_implementations = { layout = files_layout() },
            lsp_incoming_calls = { layout = files_layout() },
            lsp_outgoing_calls = { layout = files_layout() },
            lsp_references = { layout = files_layout() },
            lsp_symbols = { layout = files_layout() },
            lsp_workspace_symbols = { layout = files_layout() },
            notifications = { layout = palette_layout() },
            projects = { layout = files_layout(0.8) },
            qflist = { layout = files_layout() },
